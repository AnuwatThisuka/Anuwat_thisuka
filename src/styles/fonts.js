...
import SukhumvitSetBoldWoff from '@fonts/Sk/SukhumvitSet-Bold.woff';
import SukhumvitSetBoldWoff2 from '@fonts/Sk/SukhumvitSet-Bold.woff2';

import SukhumvitSetLightWoff from '@fonts/Sk/SukhumvitSet-Light.woff';
import SukhumvitSetLightWoff2 from '@fonts/Sk/SukhumvitSet-Light.woff2';

import SukhumvitSetMediumWoff from '@fonts/Sk/SukhumvitSet-Medium.woff';
import SukhumvitSetMediumWoff2 from '@fonts/Sk/SukhumvitSet-Medium.woff2';

const sukhumvitsetNormalWeights = {
  790: [SukhumvitSetMediumWoff, SukhumvitSetMediumWoff2],
  800: [SukhumvitSetBoldWoff, SukhumvitSetBoldWoff2],
};
...
const sk = {
  name: 'Sk',
  normal: sukhumvitsetNormalWeights,
}
...
const sukhumvit = createFontFaces(sk);
...
const Fonts = css`
  ${calibreNormal + calibreItalic + sfMonoNormal + sfMonoItalic + sukhumvit}
`;
